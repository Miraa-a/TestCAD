...
namespace XUnitTestProject1
{
    public class UnitTest1
    {
        ...
        {
            //ванна
            var ex = new Extrusion_with_hole() { Angle = 0, Length = 5, Deltha2 = 1f, Deltha1 = 3f };
            ex.points = new()
            {
        ...
        [Fact]
        public void TestExtruEx8()
        {
            //ванна
            var ex = new Extrusion_with_hole() { Angle = 5, Length = 5, Deltha2 = 1f, Deltha1 = 0.5f };
            ex.points = new()
            {
        ...
        {
            //ванна
            var ex = new Extrusion_with_hole() { Angle = -3, Length = 5, Deltha2 = 1f, Deltha1 = 0.5f };
            ex.points = new()
            {
        ...
        {
            //ванна
            var ex = new Extrusion_with_hole() { Angle = 5, Length = 5, Deltha2 = 0.1f, Deltha1 = 0.5f };
            ex.points = new()
            {
                new Vector2(0, 0),
                new Vector2(1, 0),
        ...
        {
            //ванна
            var ex = new Extrusion_with_hole() { Angle = 40, Length = 5, Deltha2 = 0.1f, Deltha1 = 0.5f };
            ex.points = new()
            {
                new Vector2(1, 0),
                new Vector2(2, 0),
